...
public class ICICI extends Account {
    ...
    public ICICI(long accountNumber, String accountHolderName, double balance, long phone,
    ...
    public void deposit(double amount) {
        if (amount > 0) {
            ...
            System.out.println("Deposited successfully in ICICI.");
        } else {
    ...
    public void withdraw(double amount) {
        if (amount > 0) {
            if (getBalance() >= amount) {
                setBalance(getBalance() - amount);
                System.out.println("Withdraw successful from ICICI.");
            } else {
    ...
    public double checkBalance() {
        // Always return the current balance
        return getBalance();
    }
